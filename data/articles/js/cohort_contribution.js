...
var annotate_graph = function(){
	//Adding Title
	var title = 'Monthly Article Edit Activity Split By Cohort - Matrix';
	$('.title').text(title);
	
	//Adding Notes
	var notes = $('<ul><li>When an article has edits >= 5/month by logged in editors the article is considered active.</li>\
<li>Articles are grouped by the month in which they were created - article cohort.</li>\
<li>X-axis No of Edit sessions, Y-axis(article cohort)</li>\
<li>Each row in a column gives the contribution in percentage of the row(article group) in the column(month). Eg: (Jan 05, Feb 05) gives the % of edit activity on the article group(row) Jan 05 in the month(column) of Feb 05</li>\
