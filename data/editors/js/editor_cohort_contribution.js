...
<li>Each row in a column gives the contribution in percentage of the row(editor group) in the column(month). Eg: (Jan 05, Feb 05) gives the % of edit activity by the editor group(row) Jan 05 in the month(column) of Feb 05</li>\
